                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide dark">
                        ...
                        <div class="video-wrap">
                            <video id="slide-video" poster="{{ asset('frontTheme/images/videos/explore-poster.jpg') }}" preload="auto" loop autoplay muted>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="swiper-slide-bg" style="background-image: url('{{ asset('frontTheme/images/slider/swiper/3.jpg') }}'); background-position: center top;"></div>
                    </div>
                </div>
    ...
    <section id="content">
        <div class="content-wrap">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 align-self-end">
                        ...
                        <div class="position-relative overflow-hidden">
                            <img src="{{ asset('frontTheme/images/services/main-fbrowser.png') }}" data-animate="fadeInUp" data-delay="100" alt="Chrome">
                            <img src="{{ asset('frontTheme/images/services/main-fmobile.png') }}" style="top: 0; left: 0; min-width: 100%; min-height: 100%;" data-animate="fadeInUp" data-delay="400" alt="iPhone" class="position-absolute">
                        </div>
            ...
            <div class="container clearfix">
                ...
                <div class="row col-mb-50 mb-4">
                    ...
                    <div class="col-lg-4 d-md-none d-lg-block text-center">
                        <img src="{{ asset('frontTheme/images/services/iphone7.png') }}" alt="iphone 2">
                    </div>
            ...
            <div class="row clearfix align-items-stretch">
                ...
                <div class="col-lg-6 center col-padding" style="background: url('{{ asset('frontTheme/images/services/main-bg.jpg') }}'); center center no-repeat; background-size: cover;">
                </div>
                ...
                <div class="col-lg-6 center col-padding" style="background-color: #F5F5F5;">
                    ...
                    <div class="center bottommargin">
                        <a class="d-block position-relative" href="https://vimeo.com/101373765" data-lightbox="iframe">
                            <img src="{{ asset('frontTheme/images/services/video.jpg') }}" alt="Video">
            ...
            <div id="portfolio" class="portfolio row no-gutters portfolio-reveal grid-container">
                    ...
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/1.jpg') }}" alt="Open Imagination">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                    <a href="{{ asset('frontTheme/images/portfolio/full/1.jpg') }}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-illustrations">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/2.jpg') }}" alt="Locked Steel Gate">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                    <a href="{{ asset('frontTheme/images/portfolio/full/2.jpg') }}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
                                    <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
                                </div>
                                <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                            </div>
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-uielements">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="#">
                                <img src="{{ asset('frontTheme/images/portfolio/4/3.jpg') }}" alt="Mac Sunglasses">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-icons pf-illustrations">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/4.jpg') }}" alt="Open Imagination">
                            </a>
                            <div class="bg-overlay" data-lightbox="gallery">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                    <a href="{{ asset('frontTheme/images/portfolio/full/4.jpg') }}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="gallery-item"><i class="icon-line-stack-2"></i></a>
                                    <a href="{{ asset('frontTheme/images/portfolio/full/4-1.jpg') }}" class="d-none" data-lightbox="gallery-item"></a>
                                    <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
                                </div>
                                <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                            </div>
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-uielements pf-media">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/5.jpg') }}" alt="Console Activity">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                                    <a href="{{ asset('frontTheme/images/portfolio/full/5.jpg') }}" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item" data-lightbox="image" title="Image"><i class="icon-line-plus"></i></a>
                                    <a href="portfolio-single.html" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="fadeInDownSmall" data-hover-animate-out="fadeOutUpSmall" data-hover-speed="350" data-hover-parent=".portfolio-item"><i class="icon-line-ellipsis"></i></a>
                                </div>
                                <div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item"></div>
                            </div>
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics pf-illustrations">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/6.jpg') }}" alt="Open Imagination">
                            </a>
                            <div class="bg-overlay" data-lightbox="gallery">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                    ...
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single-video.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/7.jpg') }}" alt="Backpack Contents">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
                ...
                <article class="portfolio-item col-6 col-md-4 col-lg-3 pf-graphics">
                    <div class="grid-inner">
                        <div class="portfolio-image">
                            <a href="portfolio-single.html">
                                <img src="{{ asset('frontTheme/images/portfolio/4/8.jpg') }}" alt="Sunset Bulb Glow">
                            </a>
                            <div class="bg-overlay">
                                <div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-parent=".portfolio-item">
            ...
            <div class="container clearfix">
                ...
                <div class="row align-items-center col-mb-50">
                    <div class="col-md-4 center">
                        <img data-animate="fadeInLeft" src="{{ asset('frontTheme/images/services/iphone6.png') }}" alt="Iphone">
                    </div>
            ...
            <div class="container">
                <div class="row posts-md col-mb-30">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="entry">
                            <div class="entry-image">
                                <a href="#"><img src="{{ asset('frontTheme/images/magazine/thumb/1.jpg') }}" alt="Image"></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="entry">
                            <div class="entry-image">
                                <a href="#"><img src="{{ asset('frontTheme/images/magazine/thumb/2.jpg') }}" alt="Image"></a>
                            </div>
                            <div class="entry-title title-xs nott">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="entry">
                            <div class="entry-image">
                                <a href="#"><img src="{{ asset('frontTheme/images/magazine/thumb/3.jpg') }}" alt="Image"></a>
                            </div>
                            <div class="entry-title title-xs nott">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="entry">
                            <div class="entry-image">
                                <a href="#"><img src="{{ asset('frontTheme/images/magazine/thumb/4.jpg') }}" alt="Image"></a>
                            </div>
                            <div class="entry-title title-xs nott">
