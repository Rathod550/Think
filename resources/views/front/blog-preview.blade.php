      ...
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <ul class="list-inline">
            ...
            <li class="list-inline-item"><a href="{{ route('blogs') }}" class="text-white">Blogs</a></li>
            <li class="list-inline-item"><span class="text-white">/</span></li>
            <li class="list-inline-item text-white-50">Blog Preview</li>
          </ul>
        </div>
      </div>
    </div>
                            ...
                            <ul class="comment-tree list-unstyled">
                                <li class="mb-5">
                                    <div class="comment-area-box">
                                        <img loading="lazy" alt="comment-author" src="{{ asset('frontTheme/images/blog/test1.jpg') }}" class="img-fluid float-left mr-3 mt-2">
                                ...
                                <li>
                                    <div class="comment-area-box">
                                        <img loading="lazy" alt="comment-author" src="{{ asset('frontTheme/images/blog/test2.jpg') }}" class="mt-2 img-fluid float-left mr-3">
