	...
	<div id="header-wrap">
		<div class="container">
			<div class="header-row">
				...
				============================================= -->
				<div id="logo">
					<a href="index.html" class="standard-logo" data-dark-logo="{{ asset('frontTheme/images/logo.png') }}"><img src="{{ asset('frontTheme/images/logo.png') }}" alt="Canvas Logo"></a>
					<a href="index.html" class="retina-logo" data-dark-logo="{{ asset('frontTheme/images/logo@2x.png') }}"><img src="{{ asset('frontTheme/images/logo@2x.png') }}" alt="Canvas Logo"></a>
				</div><!-- #logo end -->
