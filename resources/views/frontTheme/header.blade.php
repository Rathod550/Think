      ...
      <div class="row justify-content-between align-items-center">
        ...
        <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
          <div class="header-top-info mb-2 mb-md-0">
            <a href="tel:+23-345-67890">Call Us : <span>+91-9426608044</span></a>
          ...
          <nav class="navbar navbar-expand-lg px-0 py-4">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarsExample09">
              <ul class="navbar-nav ml-auto">
                ...
                {{--  <li class="nav-item {{ Request::is('blogs*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('blogs') }}">Blog</a></li> --}}
                <li class="nav-item {{ Request::is('contect') ? 'active' : '' }}"><a class="nav-link" href="{{ route('contect') }}">Contact</a></li>
              </ul>
            </div>
          </nav>
        </div>
